...
<stripes:layout-definition>
    ...
    <html>
        <head>
    		...
    		<link rel="stylesheet" href="${pageContext.request.contextPath}/plugins/metisMenu/css/metisMenu.min.css">
    		<link rel="stylesheet" href="${pageContext.request.contextPath}/css/menu.css">
    		<link rel="stylesheet" href="${pageContext.request.contextPath}/css/fim-styles.css">
    		...
    		<script type="text/javascript" src="${pageContext.request.contextPath}/plugins/metisMenu/js/metisMenu.min.js"></script>
