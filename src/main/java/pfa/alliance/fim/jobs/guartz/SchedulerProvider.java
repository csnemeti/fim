...
final class SchedulerProvider implements Provider<Scheduler> {
	...
	/**
	 * Sets the {@code JobFactory} instance (it will be a
	 * {@link InjectorJobFactory} instance).
	 *
	 * @param jobFactory
	 *            The {@code JobFactory} instance.
	 * @throws SchedulerException
	 *             If any error occurs
	 */
	@Inject
