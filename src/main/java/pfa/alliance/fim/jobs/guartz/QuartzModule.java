...
public abstract class QuartzModule extends AbstractModule {
	...
	/**
	 * Part of the EDSL builder language for configuring {@code Job}s. Here is a
	 * typical example of scheduling {@code Job}s when creating your Guice
	 * injector:
	 *
	 * <pre>
	 ...
	 *            The {@code JobListener} class has to be bound
	 */
	protected final void addJobListener(
	 ...
	 *            The {@code TriggerListener} class has to be bound
	 */
	protected final void addTriggerListener(
	 ...
	 *            The {@code SchedulerListener} class has to be bound
	 */
	protected final void addSchedulerListener(
			Class<? extends SchedulerListener> schedulerListenerType) {
		doBind(schedulerListeners, schedulerListenerType);
	}

	/**
	 * Allows {@code Job} scheduling, delegating Guice create the {@code Job}
	 * instance and inject members.
	 *
	 * If given {@code Job} class is annotated with {@link Scheduled}, then
	 * {@code Job} and related {@code Trigger} values will be extracted from it.
	 *
	 * @param jobClass
	 *            The {@code Job} has to be scheduled
	 * @return The {@code Job} builder
	 */
	protected final JobSchedulerBuilder scheduleJob(
	...
	private void checkNotNull(Class<? extends Job> jobClass, String string) {
	 ...
	 * @param type
	 */
	protected final <T> void doBind(Multibinder<T> binder,
