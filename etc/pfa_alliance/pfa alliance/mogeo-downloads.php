...
<?php include './includes/css-js.php';?>
	...
	<style type="text/css">
		.versionIcon {
			background: url('images/mogeo-logo.png');
		}
	</style>
</head>
...
<?php include './includes/header.php';?>
    <div class="container">
		<h1>MoGeo Versions</h1>
		<p class="paragraph">
		Here you can find several versions of the <a href="mogeo.php">Mogeo</a> project. Please note that versions of the application fund under 
		...
		<h2>Production</h2>
		<div class="row">
		<?= writeVersions("mogeo/", "master") ?>
		</div>
		<div class="row">
			<a href="#"  onclick="scrollToTopOfThePage()">Scroll to top</a>
			&nbsp;&nbsp;
			<a href="mogeo.php">MoGeo page</a>
		</div>
		<h2>Test</h2>
		<div class="row">
		<?= writeVersions("mogeo/", "test") ?>
		</div>
		<div class="row">
			<a href="#"  onclick="scrollToTopOfThePage()">Scroll to top</a>
			&nbsp;&nbsp;
